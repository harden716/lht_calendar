...
function daysInMonth(calDate) {
   ...
   // Extract the four digit year for the current month
   let thisYear = calDate.getFullYear();
   let thisMonth = calDate.getMonth();
   ...
   } // end of revise days in February in leap year
...
function calDays(calDate) {
   ...
   // Write blank cells preceding the starting month
   let htmlCode = "<tr>";
